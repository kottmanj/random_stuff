...
plt.plot(x1,tc1,label="cost (depth=n-qubits)")
plt.plot(x1,tg1,label="grad (depth=n-qubits)")
plt.plot(x2,tc2,label="cost (depth=100*n-qubits)")
plt.plot(x2,tg2,label="grad (depth=100*n-qubits)")
plt.plot(x3,tc3,label="cost (depth=100*n-qubits) - no-sampling", linestyle="--")
plt.plot(x3,tg3,label="grad (depth=100*n-qubits) - no-sampling", linestyle="--")
plt.xlabel("n-qubits")
plt.ylabel("time/s")
plt.yscale("log")
plt.legend()
